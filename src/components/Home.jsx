          ...
          <div className="row">
            <div className="grid md:grid-cols-2 lg:grid-cols-3">
              <div className="grid-items">
                ...
                <HashLink to={'/#contact'}><button type="button" className="font-semibold focus:outline-none text-custom-green bg-transperant hover:border border-green-700 font-medium rounded-md text-sm p-3 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"><span className='flex items-center gap-2'>
